                ...
                <div class="bg-white rounded-2xl shadow-soft border border-slate-200 p-6 md:p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $subscriptionPlan->name ?? '') }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition" placeholder="e.g. Premium Professional" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" step="0.01" name="price" value="{{ old('price', $subscriptionPlan->price ?? '') }}" class="w-full pl-4 pr-12 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition" placeholder="0.00" required>
                            ...
                            <div>
                                ...
                                <select name="currency_id" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition appearance-none cursor-pointer" required>
                                    @foreach($currencies as $currency)
                                        <option value="{{ $currency->id }}" {{ (old('currency_id', $subscriptionPlan->currency_id ?? '') == $currency->id) ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="duration_months" value="{{ old('duration_months', $subscriptionPlan->duration_months ?? 1) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition" required>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" name="discount_percent" value="{{ old('discount_percent', $subscriptionPlan->discount_percent ?? 0) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition" placeholder="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-slate-200 p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="lead_limit" value="{{ old('lead_limit', $subscriptionPlan->lead_limit ?? 0) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Service Area Limit</label>
                            <input type="number" name="service_area_limit" value="{{ old('service_area_limit', $subscriptionPlan->service_area_limit ?? 0) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Gallery Limit</label>
                            <input type="number" name="gallery_limit" value="{{ old('gallery_limit', $subscriptionPlan->gallery_limit ?? 0) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-slate-700 mb-2">Search Rank Weight</label>
                            <input type="number" name="search_rank_weight" value="{{ old('search_rank_weight', $subscriptionPlan->search_rank_weight ?? 0) }}" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-soft border border-slate-200 p-6">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:bg-slate-50 transition cursor-pointer">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $subscriptionPlan->is_featured ?? false) ? 'checked' : '' }} class="w-5 h-5 rounded-lg text-primary-500 border-slate-300 focus:ring-primary-500">
                            <div>
                        ...
                        <label class="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:bg-slate-50 transition cursor-pointer">
                            <input type="checkbox" name="is_verified_badge_included" value="1" {{ old('is_verified_badge_included', $subscriptionPlan->is_verified_badge_included ?? false) ? 'checked' : '' }} class="w-5 h-5 rounded-lg text-primary-500 border-slate-300 focus:ring-primary-500">
                            <div>
                        ...
                        <div>
                            ...
                            <select name="target" class="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 outline-none transition appearance-none cursor-pointer">
                                <option value="both" {{ (old('target', $subscriptionPlan->target ?? 'both') == 'both') ? 'selected' : '' }}>Provider & Business</option>
                                <option value="provider" {{ (old('target', $subscriptionPlan->target ?? '') == 'provider') ? 'selected' : '' }}>Provider Only</option>
                                <option value="business" {{ (old('target', $subscriptionPlan->target ?? '') == 'business') ? 'selected' : '' }}>Business Only</option>
                            </select>
                        </div>
