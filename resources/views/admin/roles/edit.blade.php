...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">Update role name and module permissions</p>
        </div>
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-soft border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 space-y-10" x-data="{ 
                ...
                @php $rolePermissionNames = old('permissions', $role->permissions->pluck('name')->toArray()); @endphp
                ...
                @empty
                    <div class="py-12 text-center bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200">
                        <p class="text-slate-400 text-sm italic">No permissions found.</p>
                    </div>
                @endforelse
            </div>
        </div>
