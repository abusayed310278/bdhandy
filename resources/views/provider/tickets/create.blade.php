...
<div class="max-w-2xl space-y-5 text-sm">
  ...
  <form action="{{ route('provider.tickets.store') }}" method="POST" class="space-y-5">
    @csrf
    ...
    <div class="flex items-center justify-end gap-3 pb-4">
      <a href="{{ route('provider.tickets.index') }}" class="px-5 py-2.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-50 transition">Cancel</a>
